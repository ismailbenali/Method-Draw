      ...
      var updateContextPanel = function(e) {
        ...
        if (elem != null) {
          ...
          if(panels[el_name]) {
            ...
            if (name_item && name_item.value ) name_item.value = Math.round(attrVal) || 0;

              if (name_item && name_item.getAttribute("data-cursor") === "true") {
...
//        var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
    ...
    var changeCanvasSize = function(ctl){
      ...
      if (window.FileReader) {
        ...
        var img_change = $('<input type="file">').change(change_image);
        $("#tool_change_img").show().prepend(img_change);
      }
    ...
    //  $('#copyright')[0].setAttribute("title", revnums);
      ...
      try{
        ...
        window.addEventListener("message", function(e){
         ...
         // console.log(e)
        let cbid = parseInt(e.data.substr(0, e.data.indexOf(";")));
        try{
